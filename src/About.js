    ...
    <div>
      <div className="flex">
        <div className="section-hero-data">
          <p className="hero-top-data">ABOUT ME</p>
          <h1 className="hero-heading">I can develop
that help people</h1>
          <p className="hero-para">
          I am Devarsh Chandiwade, a web developer with expertise in front-end and back-end development. I create visually appealing and functional websites using HTML, CSS, JavaScript, and other modern web technologies. Check out my portfolio for a glimpse of my work!
          </p>
      ...
      <Tabs className="Tabs" activeKey={key} onSelect={(k) => setKey(k)}>
        <TabList>
          <Tab eventKey="tab1">Biography -- 01</Tab>
          <Tab eventKey="tab2">Skills -- 02</Tab>
          <Tab eventKey="tab3">Education -- 03</Tab>
        </TabList>
        <TabPanel>
